...
private:
  ...
  const unsigned long delayDuration = 1000;  // 1 giây delay
...
public:
  ...
  void updateAll() {
    ...
    if (currentState == PICKUP) {
      ...
      if (currentFruitClass == "Apple Ripe") moveToAppleRipe();
      else if (currentFruitClass == "Apple Rot") moveToAppleRot();
      else if (currentFruitClass == "Pear Ripe") moveToPearRipe();
      else if (currentFruitClass == "Pear Rot") moveToPearRot();
      else if (currentFruitClass == "Grapes Ripe") moveToGrapesRipe();
      else if (currentFruitClass == "Grapes Rot") moveToGrapesRot();
