...
export class FruitClassificationService {
  ...
  async create(
    ...
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình tạo trái cây',
      );
    }
  }
  ...
  async findAll(): Promise<FruitClassification[]> {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy danh sách trái cây',
      );
    }
  }
  ...
  update(
    ...
    updateFruitClassificationDto: UpdateFruitClassificationDto,
  ) {
