...
export class StatisticalService {
  ...
  async getAmountUsers() {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy số lượng tài khoản',
      );
    }
  }
  ...
  async getAmountFruits() {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy số lượng loại trái cây',
      );
    }
  }
  ...
  async getAmountClassifyResult() {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy số lượng kết quả phân loại trái cây',
      );
    }
  }
  ...
  async getAmountEmployees() {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy số lượng nhân viên',
      );
    }
  }
  ...
  async getAmountFruitTypes() {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy số lượng tình trạng trái cây',
      );
    }
  }
  ...
  async getAmountAreas() {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy số lượng khu vực phân loại',
      );
    }
  }
  ...
  async getAmountDevices() {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy số lượng thiết bị',
      );
    }
  }
  ...
  async getAmountDeviceTypes() {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy số lượng loại thiết bị',
      );
    }
  }
  ...
  async getClassifyStatisticChartByDaysOfWeek(fruitName: string) {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy dữ liệu cho biểu đồ thống kê kết quả phân loại theo ngày trong tuần',
      );
    }
  }
  ...
  async getClassifyStatisticChartByMonth(fruitName: string) {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy dữ liệu cho biểu đồ thống kê kết quả phân loại trong tháng hiện tại',
      );
    }
  }
  ...
  async getClassifyStatisticChartByYear(fruitName: string) {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy dữ liệu cho biểu đồ thống kê kết quả phân loại trong 1 năm',
      );
    }
  }
  ...
  async getRatioOfFruits() {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy tỉ lệ các loại trái cây',
      );
    }
  }
  ...
  async getEmployeesInEachArea() {
    try {
      ...
      throw new InternalServerErrorException(
        'Xảy ra lỗi từ phía server trong quá trình lấy số lượng nhân viên thuộc mỗi khu phân loại',
      );
    }
  }
}
