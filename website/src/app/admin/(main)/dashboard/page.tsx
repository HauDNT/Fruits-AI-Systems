'use client';
import { Apple, Cpu, Users, HeartPulse, ScanEye, Computer, Zap, UserCircle } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const cardItems: DashboardCardItem[] = [
    ...
    {
      name: 'Loại thiết bị',
      number: cardData.amountDeviceTypes,
      icon: Zap,
      disableAnimation: false,
    },
  ];
    ...
    <div className="grid grid-cols-12 gap-4 md:gap-6">
      ...
      {ratioFruits ? (
        <div className="col-span-4 space-y-6">
          <PieChartFruitDistribution chartName={'Tỉ lệ các loại trái cây'} data={ratioFruits} />
        </div>
      ) : (
        <div className="col-span-4 space-y-6">Không tải được dữ liệu phân bổ các loại trái cây</div>
      )}
    </div>
  );
}
