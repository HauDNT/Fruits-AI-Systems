...
export default function MonthlyAccountCreatedChart() {
    const options: ApexOptions = {
        colors: ["#465fff", "#eb255a", "#ebbd25"],
        chart: {
    ...
    const series = [
        ...
        {
            name: "Nho",
            data: [108, 290, 51, 202, 357, 50, 35, 120, 25, 309, 20, 20],
        },
    ];
        ...
        <div
            ...
            <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white/90">
                    Lượng lô trái cây được nhập trong năm
                </h3>
            </div>
