...
const ChangeAreaInfoForm = ({
  ...
  const updateAreaData = async (): Promise<void> => {
    try {
      ...
      const resData = await axiosInstance.put('/areas/update', form, {
            ...
            <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
              ...
              <div className="order-3 xl:order-2">
                ...
                <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                  <p className="text-sm text-gray-500 dark:text-gray-400">{formData.area_desc}</p>
                </div>
              </div>
            </div>
            {editState ? (
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                    <ToggleLabelInput
                      ...
                      fieldType={'input'}
                      onFieldChange={(value) =>
                        onChangeDataEachFieldChange('area_desc', value, (field, value) =>
                          setFormData((prev) => ({
                            ...prev,
                            [field]: value,
                          })),
