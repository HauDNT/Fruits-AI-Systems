...
const AppSidebar: React.FC = () => {
    ...
    const roleState: SidebarType = useSelector((state: RootState) => {
        const role = state.auth && state.auth.user ? state.auth.user.role : "Unknown";
        return Object.values(RoleEnum).includes(role) ? role : "Unknown";
    });

    const navItems: NavItem[] = AdminSidebarItems;
